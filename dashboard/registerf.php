...
if (isset($_POST['btn']) && $_POST['btn'] == "1") {
    ...
    if (strlen($pass) < 2 && $email_ok == true) {
        $_SESSION['fail_message'] = 'Lozinka ima manje od 8 karaktera.';
    } else {
...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="">Registruj<b>SE</b><br>--== kao frizer ==--</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="registerf.php" method="post">
                    <div class="input-group mb-3">
                        <input name="name" type="text" class="form-control" placeholder="Ime" <?php echo $name_value; ?> required autocomplete="off">
