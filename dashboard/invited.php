...
if (isset($_GET['email']) && $_GET['email']!='') {
    ...
    if ($result->num_rows > 0) {
        $_SESSION['fail_message'] =$email. ' je već u bazi.';
        ...
        <aside class="main-sidebar  sidebar-dark-secondary elevation-4">
            ...
            <div class="sidebar sidebar-dark-primary">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a class="d-block disabled">Kao Neki Frizer(ka)</a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
               ...
               <li class="nav-item">
                            <a href="view_cal.php" class="nav-link  disabled">
                                <i class="nav-icon fas fa-calendar-alt"></i>
                                <p>Kalendar</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="view_services.php" class="nav-link  disabled">
