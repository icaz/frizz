                                    ...
                                    <tbody>
                                        ...
                                        foreach ($keys as $key) {
                                            if ($h[$key] > 0) {
                                                ...
                                                echo '<tr '.$style.' href="#commentModal" data-toggle="modal" data-vreme="' . $key . '">';
                                                echo '<td>' . $key . '</td>';
                                                echo '<td rowspan="' . $h[$key] . '">' . $desc[$key] . '</td></tr>';
                                                $busy = $h[$key];
                                            } else {
                                                echo '<tr class="clickable-tr table-success" href="#commentModal" data-toggle="modal" data-vreme="' . $key . '">';
                                                echo '<td>' . $key . '</td>';
                                                if ($busy == 0) {
                                                    echo '<td></td>';
                                                }
